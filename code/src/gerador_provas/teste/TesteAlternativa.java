...
//		
		...
		//alternativaDAO.cadastrar(alternativas, questao);
                ...
                int Id = 1; //determinando ID MANUAL PARA ATUALIZAR E EXCLUIR
                String alternativa = "TESTE DE UPDATE";
                Blob imagem = null;
                int correta = 1;
              //  alternativaDAO.atualizar(new Alternativa(Id, alternativa, imagem));
              //  alternativaDAO.deletar(new Alternativa(Id, alternativa, imagem));
